<template>
    <div class="row" >
        <div class="service-panel col-xs-12" @click="toggle">
            <h4>{{ _categoryName }}</h4>
...
<script type="text/babel">
    ...
    import VisibleStepService from './VisibleStepService'
...
//            },
            ...
            _categoryName () {
                return this._isExtra ? `${this.categoryName} additional services` : `${this.categoryName} prices`
            },
