...
exports.install = function(Vue, globalOptions) {
  ...
  Vue.component('vf-timerange',require('./lib/components/fields/timerange')());
  Vue.component('vf-slider',require('./lib/components/fields/slider')(Vue));
  Vue.component('vf-num',require('./lib/components/fields/num')());
  Vue.component('vf-num-placeholder',require('./lib/components/fields/num-placeholder')());
  Vue.component('vf-timerange-select',require('./lib/components/fields/timerange-select')());
  Vue.component('vf-switch',require('./lib/components/fields/switch')());
  ...
  Vue.partial('number',require('./lib/templates/number.html'));
  ...
  Vue.partial('timerange',require('./lib/templates/timerange.html'));
  Vue.partial('slider',require('./lib/templates/slider.html'));
  Vue.partial('num',require('./lib/templates/num.html'));
  Vue.partial('num-placeholder',require('./lib/templates/num-placeholder.html'));
  Vue.partial('timerangeSelect',require('./lib/templates/timerange-select.html'));
  Vue.partial('switch',require('./lib/templates/switch.html'));
