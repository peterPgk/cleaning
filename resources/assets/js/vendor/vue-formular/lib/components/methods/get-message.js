module.exports = function(rule) {
  ...
  var messages = this.getForm().options.messages;
    ...
    //Заради file полето слагам || клаузата
    ...
    params.forEach(function(param, index) {
      ...
      if (relatedField)
       message = message.replace(":relatedField", this.label?stripLabel(this.label):this.errMsg?this.errMsg:this.name);
       }
  }

    message = message.replace(":field", this.label?stripLabel(this.label):this.errMsg?this.errMsg:this.name);
